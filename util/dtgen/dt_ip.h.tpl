...
/** Default register block (associated with the "main" set of registers). */
<%
  default_reg_block_name = (helper.reg_block_enum.name + Name(["default"])).as_c_enum()
 ...
 * List of pins.
 *
 * Pins are guaranteed to be numbered consecutively from 0.
 */
${helper.pin_enum.render()}
