        ...
        for idx, path in enumerate(out_paths):
            ...
            for m in module_types:
                ...
                if m in top_reggen_module_types:
                    ...
                    dt_ipgen_headers.append(f"dt_{m}.h")
                elif m in templated_module_types | ipgen_module_types:
                    dt_header_path = f'hw/top_{topname}/sw/autogen/devicetables/dt_{m}.h'
                    dt_api_out_path = f'sw/autogen/devicetables/dt_{m}.h'
                    include_guard = (
                        f'opentitan_hw_top_{topcfg["name"]}_sw_autogen_devicetables_dt_{m}_h_'
            ...
            # Autogenerated BUILD file for autogenerated header files.

            # "devicetables_BUILD.tpl" -> "sw/autogen/devicetables/BUILD"
            render_template(TOPGEN_TEMPLATE_PATH / "devicetables_BUILD.tpl",
                            dt_dir / "BUILD",
                            helper = c_helper,
                            dt_ipgen_headers = dt_ipgen_headers,
                            gencmd = gencmd)

            # "devicetables.c.tpl" -> "sw/autogen/devicetables/devicetables.c"
            render_template(TOPGEN_TEMPLATE_PATH / "devicetables.c.tpl",
                            cformat_dir / "devicetables.c",
                            helper = c_helper,
                            dt_headers = dt_headers,
                            gencmd = gencmd)

            # "devicetables.h.tpl" -> "sw/autogen/devicetables/devicetables.h"
            render_template(TOPGEN_TEMPLATE_PATH / "devicetables.h.tpl",
                            cformat_dir / "devicetables.h",
                            helper = c_helper,
                            dt_headers = dt_headers,
                            gencmd = gencmd)

            # "dt_api.h.tpl" -> "sw/autogen/devicetables/dt_api.h"
            render_template(TOPGEN_TEMPLATE_PATH / "dt_api.h.tpl",
                            cformat_dir / "dt_api.h",
                            helper = c_helper,
                            gencmd = gencmd)
            ...
            memory_cheader_path = cformat_dir / f"BUILD"
