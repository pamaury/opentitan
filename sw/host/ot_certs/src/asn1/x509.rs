...
impl X509 {
    ...
    pub fn push_tbs_certificate(builder: &mut dyn Builder, cert: &Certificate) -> Result<()> {
        // From https://datatracker.ietf.org/doc/html/rfc5280#section-4.1:
    ...
    pub fn push_basic_constraints_ext(builder: &mut dyn Builder) -> Result<()> {
    ...
    pub fn push_key_usage_ext(builder: &mut dyn Builder) -> Result<()> {
    ...
    pub fn push_subject_key_id_ext(
        builder: &mut dyn Builder,
        auth_key_id: &Value<Vec<u8>>,
    ) -> Result<()> {
    ...
    pub fn push_extension(
        ...
        oid: &Oid,
        critical: bool,
        gen: &dyn Fn(&mut dyn Builder) -> Result<()>,
    ) -> Result<()> {
        // From https://datatracker.ietf.org/doc/html/rfc5280#section-4.1:
        // Extension  ::=  SEQUENCE  {
    ...
    pub fn push_ec_public_key_params(
        builder: &mut dyn Builder,
    ...
    pub fn push_ec_public_key(builder: &mut dyn Builder, pubkey: &EcPublicKeyInfo) -> Result<()> {
    ...
    pub fn push_validity(builder: &mut dyn Builder) -> Result<()> {
        // From https://datatracker.ietf.org/doc/html/rfc5280#section-4.1:
        // Validity ::= SEQUENCE {
        //   notBefore      Time,
        //   notAfter       Time }
    ...
    pub fn push_sig_alg_id(builder: &mut dyn Builder, sig: &Signature) -> Result<()> {
        // From https://datatracker.ietf.org/doc/html/rfc5280#section-4.1.1.2
        // AlgorithmIdentifier  ::=  SEQUENCE  {
        // algorithm               OBJECT IDENTIFIER,
        // parameters              ANY DEFINED BY algorithm OPTIONAL  }
    ...
    pub fn push_signature(builder: &mut dyn Builder, sig: &Signature) -> Result<()> {
        match sig {
    ...
    pub fn push_ecdsa_sig(builder: &mut dyn Builder, sig: &EcdsaSignature) -> Result<()> {
