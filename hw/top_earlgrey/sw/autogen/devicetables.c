    ...
    .__internal = {
      ...
      .pins = {
        [kDtFlashCtrlPinTck] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInFlashCtrlTck,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtFlashCtrlPinTms] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInFlashCtrlTms,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtFlashCtrlPinTdi] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInFlashCtrlTdi,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtFlashCtrlPinTdo] = {
          .__internal = {
            ...
            .outsel = kTopEarlgreyPinmuxOutselFlashCtrlTdo,
          }
        },
      },
    },
    ...
    .__internal = {
      ...
      .pins = {
        [kDtGpioPinGpio0] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio0,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio0,
          }
        },
        [kDtGpioPinGpio1] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio1,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio1,
          }
        },
        [kDtGpioPinGpio2] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio2,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio2,
          }
        },
        [kDtGpioPinGpio3] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio3,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio3,
          }
        },
        [kDtGpioPinGpio4] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio4,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio4,
          }
        },
        [kDtGpioPinGpio5] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio5,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio5,
          }
        },
        [kDtGpioPinGpio6] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio6,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio6,
          }
        },
        [kDtGpioPinGpio7] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio7,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio7,
          }
        },
        [kDtGpioPinGpio8] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio8,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio8,
          }
        },
        [kDtGpioPinGpio9] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio9,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio9,
          }
        },
        [kDtGpioPinGpio10] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio10,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio10,
          }
        },
        [kDtGpioPinGpio11] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio11,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio11,
          }
        },
        [kDtGpioPinGpio12] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio12,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio12,
          }
        },
        [kDtGpioPinGpio13] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio13,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio13,
          }
        },
        [kDtGpioPinGpio14] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio14,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio14,
          }
        },
        [kDtGpioPinGpio15] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio15,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio15,
          }
        },
        [kDtGpioPinGpio16] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio16,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio16,
          }
        },
        [kDtGpioPinGpio17] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio17,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio17,
          }
        },
        [kDtGpioPinGpio18] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio18,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio18,
          }
        },
        [kDtGpioPinGpio19] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio19,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio19,
          }
        },
        [kDtGpioPinGpio20] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio20,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio20,
          }
        },
        [kDtGpioPinGpio21] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio21,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio21,
          }
        },
        [kDtGpioPinGpio22] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio22,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio22,
          }
        },
        [kDtGpioPinGpio23] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio23,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio23,
          }
        },
        [kDtGpioPinGpio24] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio24,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio24,
          }
        },
        [kDtGpioPinGpio25] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio25,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio25,
          }
        },
        [kDtGpioPinGpio26] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio26,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio26,
          }
        },
        [kDtGpioPinGpio27] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio27,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio27,
          }
        },
        [kDtGpioPinGpio28] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio28,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio28,
          }
        },
        [kDtGpioPinGpio29] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio29,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio29,
          }
        },
        [kDtGpioPinGpio30] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio30,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio30,
          }
        },
        [kDtGpioPinGpio31] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInGpioGpio31,
            .outsel = kTopEarlgreyPinmuxOutselGpioGpio31,
          }
        },
      },
    },
    ...
    .__internal = {
      ...
      .pins = {
        [kDtI2cPinSda] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInI2c0Sda,
        ...
        [kDtI2cPinScl] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInI2c0Scl,
    ...
    .__internal = {
      ...
      .pins = {
        [kDtI2cPinSda] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInI2c1Sda,
        ...
        [kDtI2cPinScl] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInI2c1Scl,
    ...
    .__internal = {
      ...
      .pins = {
        [kDtI2cPinSda] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInI2c2Sda,
        ...
        [kDtI2cPinScl] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInI2c2Scl,
      ...
      .pins = {
        [kDtOtpCtrlPinTest0] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselOtpCtrlTest0,
          }
        },
      },
    },
      ...
      .pins = {
        [kDtPattgenPinPda0Tx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPattgenPda0Tx,
          }
        },
        [kDtPattgenPinPcl0Tx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPattgenPcl0Tx,
          }
        },
        [kDtPattgenPinPda1Tx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPattgenPda1Tx,
          }
        },
        [kDtPattgenPinPcl1Tx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPattgenPcl1Tx,
          }
        },
      },
    },
      ...
      .pins = {
        [kDtPwmPinPwm0] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPwmAonPwm0,
          }
        },
        [kDtPwmPinPwm1] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPwmAonPwm1,
          }
        },
        [kDtPwmPinPwm2] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPwmAonPwm2,
          }
        },
        [kDtPwmPinPwm3] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPwmAonPwm3,
          }
        },
        [kDtPwmPinPwm4] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPwmAonPwm4,
          }
        },
        [kDtPwmPinPwm5] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselPwmAonPwm5,
          }
        },
      },
    },
      ...
      .pins = {
        [kDtSensorCtrlPinAstDebugOut0] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut0,
          }
        },
        [kDtSensorCtrlPinAstDebugOut1] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut1,
          }
        },
        [kDtSensorCtrlPinAstDebugOut2] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut2,
          }
        },
        [kDtSensorCtrlPinAstDebugOut3] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut3,
          }
        },
        [kDtSensorCtrlPinAstDebugOut4] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut4,
          }
        },
        [kDtSensorCtrlPinAstDebugOut5] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut5,
          }
        },
        [kDtSensorCtrlPinAstDebugOut6] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut6,
          }
        },
        [kDtSensorCtrlPinAstDebugOut7] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut7,
          }
        },
        [kDtSensorCtrlPinAstDebugOut8] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSensorCtrlAonAstDebugOut8,
          }
        },
      },
    },
    ...
    .__internal = {
      ...
      .pins = {
        [kDtSpiDevicePinSck] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiDeviceSck,
            .outsel = 0,
          }
        },
        [kDtSpiDevicePinCsb] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiDeviceCsb,
            .outsel = 0,
          }
        },
        [kDtSpiDevicePinTpmCsb] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSpiDeviceTpmCsb,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtSpiDevicePinSd0] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiDeviceSd0,
            .outsel = 0,
          }
        },
        [kDtSpiDevicePinSd1] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiDeviceSd1,
            .outsel = 0,
          }
        },
        [kDtSpiDevicePinSd2] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiDeviceSd2,
            .outsel = 0,
          }
        },
        [kDtSpiDevicePinSd3] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiDeviceSd3,
            .outsel = 0,
          }
        },
      },
    ...
    .__internal = {
      ...
      .pins = {
        [kDtSpiHostPinSck] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiHost0Sck,
            .outsel = 0,
          }
        },
        [kDtSpiHostPinCsb] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiHost0Csb,
            .outsel = 0,
          }
        },
        [kDtSpiHostPinSd0] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiHost0Sd0,
            .outsel = 0,
          }
        },
        [kDtSpiHostPinSd1] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiHost0Sd1,
            .outsel = 0,
          }
        },
        [kDtSpiHostPinSd2] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiHost0Sd2,
            .outsel = 0,
          }
        },
        [kDtSpiHostPinSd3] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSpiHost0Sd3,
            .outsel = 0,
          }
        },
      },
      ...
      .pins = {
        [kDtSpiHostPinSck] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSpiHost1Sck,
          }
        },
        [kDtSpiHostPinCsb] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSpiHost1Csb,
          }
        },
        [kDtSpiHostPinSd0] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSpiHost1Sd0,
            .outsel = kTopEarlgreyPinmuxOutselSpiHost1Sd0,
          }
        },
        [kDtSpiHostPinSd1] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSpiHost1Sd1,
            .outsel = kTopEarlgreyPinmuxOutselSpiHost1Sd1,
          }
        },
        [kDtSpiHostPinSd2] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSpiHost1Sd2,
            .outsel = kTopEarlgreyPinmuxOutselSpiHost1Sd2,
          }
        },
        [kDtSpiHostPinSd3] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSpiHost1Sd3,
            .outsel = kTopEarlgreyPinmuxOutselSpiHost1Sd3,
          }
        },
      },
    },
    ...
    .__internal = {
      ...
      .pins = {
        [kDtSysrstCtrlPinAcPresent] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSysrstCtrlAonAcPresent,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtSysrstCtrlPinKey0In] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSysrstCtrlAonKey0In,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtSysrstCtrlPinKey1In] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSysrstCtrlAonKey1In,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtSysrstCtrlPinKey2In] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSysrstCtrlAonKey2In,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtSysrstCtrlPinPwrbIn] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSysrstCtrlAonPwrbIn,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtSysrstCtrlPinLidOpen] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInSysrstCtrlAonLidOpen,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtSysrstCtrlPinBatDisable] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSysrstCtrlAonBatDisable,
          }
        },
        [kDtSysrstCtrlPinKey0Out] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSysrstCtrlAonKey0Out,
          }
        },
        [kDtSysrstCtrlPinKey1Out] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSysrstCtrlAonKey1Out,
          }
        },
        [kDtSysrstCtrlPinKey2Out] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSysrstCtrlAonKey2Out,
          }
        },
        [kDtSysrstCtrlPinPwrbOut] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSysrstCtrlAonPwrbOut,
          }
        },
        [kDtSysrstCtrlPinZ3Wakeup] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kDtPinPeriphInputNone,
            .outsel = kTopEarlgreyPinmuxOutselSysrstCtrlAonZ3Wakeup,
          }
        },
        [kDtSysrstCtrlPinEcRstL] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSysrstCtrlAonEcRstL,
            .outsel = 0,
          }
        },
        [kDtSysrstCtrlPinFlashWpL] = {
          .__internal = {
            .type = kDtPinTypeDio,
            .periph_input_or_direct_pad = kTopEarlgreyDirectPadsSysrstCtrlAonFlashWpL,
            .outsel = 0,
          }
        },
      },
    ...
    .__internal = {
      ...
      .pins = {
        [kDtUartPinRx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInUart0Rx,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtUartPinTx] = {
    ...
    .__internal = {
      ...
      .pins = {
        [kDtUartPinRx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInUart1Rx,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtUartPinTx] = {
    ...
    .__internal = {
      ...
      .pins = {
        [kDtUartPinRx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInUart2Rx,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtUartPinTx] = {
    ...
    .__internal = {
      ...
      .pins = {
        [kDtUartPinRx] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInUart3Rx,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtUartPinTx] = {
    ...
    .__internal = {
      ...
      .pins = {
        [kDtUsbdevPinSense] = {
          .__internal = {
            .type = kDtPinTypeMio,
            .periph_input_or_direct_pad = kTopEarlgreyPinmuxPeripheralInUsbdevSense,
            .outsel = kDtPinOutselNone,
          }
        },
        [kDtUsbdevPinUsbDp] = {
          .__internal = {
            .type = kDtPinTypeOther,
